...
if(pageType != 'join'){
	...
	swfobject.embedSWF("swf/index.swf", "main_flash", "100%", "710", "10.0.0" , null, flashvars , params , attributes  );			
...
/* 		$('.join_iframe').css({'top':-560}).animate({'top':95}, {duration:1000, easing:"easeOutExpo"}); */
	...
	function closeJoin(){
		...
		/* $('.join_iframe').animate({'top':-560}, {duration:1000, easing:"easeInExpo"}); */
