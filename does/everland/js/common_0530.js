					...
					for (var i = 0; i < cardIndexList.length; i++) {
						...
						if (cardIndexList[i].length > 0)
						{
							...
							if (cardIndexList[i] == 0) {
								$(".mycard_list li:eq(0) img").attr("src","/web/lostvalley/images/common/card_1.png");
								myCard1= true;
							} else if (cardIndexList[i] == 1) {
								$(".mycard_list li:eq(1) img").attr("src","/web/lostvalley/images/common/card_2.png");
								myCard2= true;
							} else if (cardIndexList[i] == 2) {
								$(".mycard_list li:eq(2) img").attr("src","/web/lostvalley/images/common/card_3.png");
								myCard3= true;
							} else if (cardIndexList[i] == 3) {
								$(".mycard_list li:eq(3) img").attr("src","/web/lostvalley/images/common/card_4.png");
								myCard4= true;
							} else if (cardIndexList[i] == 4) {
								$(".mycard_list li:eq(4) img").attr("src","/web/lostvalley/images/common/card_5.png");
								myCard5= true;
							} else if (cardIndexList[i] == 5) {
								$(".mycard_list li:eq(5) img").attr("src","/web/lostvalley/images/common/card_6.png");
								myCard6= true;
							} else if (cardIndexList[i] == 6) {
								$(".mycard_list li:eq(6) img").attr("src","/web/lostvalley/images/common/card_7.png");
								myCard7= true;
							}
						}
					};
...
function setLoadingDiv(){
	if($("#loading").length>0){
		...
		var loading="<div id=\"loading\"><img src=\"/web/lostvalley/images/common/loading.gif\" alt=\"loading\"/></div>"; // modified by sanghun 4/24
...
function storyFlipSet(){
	...
	var currentPage = 0;
	var imgPath = "/web/lostvalley/images/storybook/";
	...
	var setCurrentPage = function(page){
		...
		$($("#story_seq img")[0]).attr("src","/web/lostvalley/images/storybook/99.jpg");
...
function gallerySet(){
	...
	$(".gallery_thumb_menu ul li a").click(function(e){
		...
		$(".gallery_img_area img").attr("src","/web/lostvalley/images/gallery/img"+liIdx+".jpg");
...
*/
	...
	$(".note_view_animal_btn").click(function(e){
			...
			if(animalBtnClick){
				...
				$(".note_view_animal_btn a img").attr("src","/web/lostvalley/images/note/btn_txt.png");
				...
				$(".note_view_animal_btn a img").attr("src","/web/lostvalley/images/note/btn_img.png");
